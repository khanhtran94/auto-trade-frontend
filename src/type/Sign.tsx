interface Sign {
    ...
    entryFrom: string | null; // Replace null with appropriate type if entry_from can't be null
    entryTo: string | null; // Replace null with appropriate type if entry_to can't be null
    status: number;
